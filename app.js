...
function Orcamento(_ref0) {
  ...
  var EquipeEditRow = function EquipeEditRow(_ref) {
    var item = _ref.item;
    return /*#__PURE__*/React.createElement("div", {
      ...
      type: "number",
      value: vals[item.key] || "",
      onChange: function onChange(v) { return setVal(item.key, v); },
